...
namespace TestWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult ExampleButton()
        {
            return View();
        }

        public ActionResult ExampleCheckBox()
        {
            return View();
        }

        public ActionResult ExampleTextBox()
        {
            return View();
        }
        ...
        public ActionResult ExampleTable()
        {
            return View();
        }
        ...
        public ActionResult ExampleDetail()
        {
            return View();
        }
        #region 导出报告
        public ActionResult ExampleExport()
        {
            return View();
        }
        ...
        public ActionResult ExamplePop()
        {
            return View();
        }

        public ActionResult ExampleAlert()
        {
            return View();
        }

        public ActionResult ExampleSelectList()
        {
            return View();
        }
        public ActionResult ExampleValidate()
        {
            return View();
        }

        public ActionResult ExampleUpload()
        {
            return View();
        }
        public ActionResult ExampleDate()
        {
            return View();
        }
        #region Extend
