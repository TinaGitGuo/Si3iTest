...
; (function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = (this.options.toolbarSettings.showNextButton !== false) ? $('<button></button>').html('<span>' + this.options.lang.next + '</span>' + '<i class="icon-arrow-right-large"></i>').addClass('sw-btn-next B1').attr('type', 'button') : null;
            var btnPrevious = (this.options.toolbarSettings.showPreviousButton !== false) ? $('<button></button>').html('<i class="icon-arrow-left-large" ></i>' + '<span>' + this.options.lang.previous + '</span>').addClass('sw-btn-prev B1').attr('type', 'button') : null;
            ...
            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                ...
                btnGroupExtra2 = $('<div></div>').addClass('btn-group navbar-btn sw-btn-group-extra pull-' + this.options.toolbarSettings.toolbarButtonPosition).attr('role', 'group');
                $.each(this.options.toolbarSettings.toolbarExtraButtons, function (i, n) {
                    if (n.text() == '发布') {
                        btnGroupExtra2.append(n.clone(true));
                    } else {
            ...
            switch (this.options.toolbarSettings.toolbarPosition) {
                case 'top':
                    ...
                    toolbarTop.append(btnGroupExtra2);
                ...
                case 'bottom':
                    ...
                    toolbarBottom.append(btnGroupExtra2);
                ...
                case 'both':
                    ...
                    toolbarBottom = $('<nav></nav>').addClass('navbar btn-toolbar sw-toolbar sw-toolbar-bottom');
                    toolbarBottom.append(btnGroupExtra2.clone(true));
        ...
        _setEvents: function () {
            ...
            $('.sw-btn-next', this.main).on("click", function (e) {
                e.preventDefault();
                if (mi.options.nextStep && Object.prototype.toString.call(mi.options.nextStep) === '[object Function]') {
                    mi.options.nextStep();
                } else {
            ...
            $('.sw-btn-prev', this.main).on("click", function (e) {
                e.preventDefault();
                if (mi.options.prevStep && Object.prototype.toString.call(mi.options.prevStep) === '[object Function]') {
                    mi.options.prevStep();
                } else {
                    if (mi.steps.index(this) !== mi.current_index) {
                        mi._showPrevious();
